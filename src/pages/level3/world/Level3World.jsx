    ...
    <group>
      <RigidBody type='fixed' colliders='trimesh'>
        <group {...props} dispose={null}>
          ...
          <mesh geometry={nodes.Floor.geometry} material={materials.Floor} castShadow receiveShadow />
          <mesh geometry={nodes.Miniroom.geometry} material={nodes.Miniroom.material} castShadow receiveShadow>
            <meshToonMaterial {...propsTexture} />
          </mesh>
          <mesh geometry={nodes.Miniroom_Floor.geometry} material={materials.Floor} castShadow receiveShadow />
          <mesh geometry={nodes.Maze__Outside_Walls.geometry} material={nodes.Maze__Outside_Walls.material} receiveShadow>
            <meshToonMaterial {...propsTexture} />
          </mesh>
          <mesh geometry={nodes.Trunk.geometry} material={materials.hept32} castShadow receiveShadow />
          <mesh geometry={nodes.Trees_Group.geometry} material={materials.hept32} castShadow receiveShadow />
          {/* Arboles reales */}
          <mesh geometry={nodes.Trees_Group_9.geometry} material={materials.hept32} receiveShadow />
          <mesh geometry={nodes.Trees_Group_10.geometry} material={materials.hept32} receiveShadow />
          <mesh geometry={nodes.Trees_Group_11.geometry} material={materials.hept32} receiveShadow />
          <mesh geometry={nodes.Trees_Group_12.geometry} material={materials.hept32} receiveShadow />
          <mesh geometry={nodes.Trees_Group_13.geometry} material={materials.hept32} receiveShadow />
          <mesh geometry={nodes.Trees_Group_14.geometry} material={materials.hept32} receiveShadow />
          <mesh geometry={nodes.Trees_Group_15.geometry} material={materials.hept32} receiveShadow />
        </group>
      </RigidBody>
    </group>
